        ...
        <footer className="flex flex-row h-[250px] lg:h-[200px] lg:max-h-[200px] text-white text-lg bg-[#A5AF8D] p-1 lg:p-6 lg:px-20">
            <div className="flex flex-row items-center justify-between w-full">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-center gap-6 w-[20%]">
                    ...
                    <a href=""><FaInstagram className="text-2xl hover:scale-125 hover:text-[#c94949] transition-all cursor-pointer" /></a>
                    <a href=""><FaYoutube className="text-2xl hover:scale-125 hover:text-[#ca3434] transition-all cursor-pointer" /></a>
                    <a href=""><FaFacebook className="text-2xl hover:scale-125 hover:text-[#403f8d] transition-all cursor-pointer" /></a>
                </div>
            </div>
        </footer>
    );
