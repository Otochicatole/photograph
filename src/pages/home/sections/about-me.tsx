...
const SectionTitle = ({ children }: { children: string }) => (
    <h2 className="text-[#545454] text-[38px] mb-16 font-[Ovtreasure]">{children}</h2>
);
        ...
        <div className="flex flex-col w-full items-center justify-center">
            ...
            <div className="flex flex-row items-center max-w-[800px] justify-center gap-3">
                <div className="relative flex flex-col min-w-[300px] min-h-[440px]">
                    <Suspense fallback={<div className="w-[300px] h-[440px] bg-gray-200 rounded-lg"></div>}>
                        ...
                        <LazyImage className="w-[300px] h-[440px] object-cover rounded-[10px] drop-shadow-lg z-10" src="./FOTOGRAFIAS/FOTOGRAFO/1.jpg" />
                    </Suspense>
                </div>
                <div className="flex flex-col h-full w-full p-3">{text.imgText}</div>
            </div>
            ...
            <div className="relative flex flex-col items-center justify-center w-[400px] mt-26">
                <Suspense fallback={<div className="w-[124px] h-[230px] bg-transparent"></div>}>
                    <LazyImage className="absolute rotate-99 z-0 opacity-50  right-22 w-[124px] h-[230px]" src="./RECURSOS/hoja2.png" />
                </Suspense>
            ...
            <div className="flex flex-row justify-between gap-3 w-[60%] mt-10">
                {[
                    ...
                    <div key={title} className="flex flex-col max-w-[366px] text-center">
                        <h2 className="text-[#798B95] text-[38px] font-[Ovtreasure]">{title}</h2>
                        {text}
                    </div>
                ))}
            </div>
            ...
            <div className="flex flex-row items-center max-w-[1000px] justify-center gap-55">
                <div className="relative flex flex-col min-w-[300px] min-h-[440px]">
                    <Suspense fallback={<div className="w-[300px] h-[440px] bg-gray-200 rounded-lg"></div>}>
                        ...
                        <LazyImage className="absolute -bottom-16 -right-3 rotate-135 w-[147px] h-[261px] z-0" src="./RECURSOS/hoja1.png" />
                        <LazyImage className="w-[300px] h-[440px] object-cover rounded-[10px] drop-shadow-lg z-10" src="./FOTOGRAFIAS/FOTOGRAFO/1.jpg" />
                    </Suspense>
                </div>
                <div className="flex flex-col h-full w-full p-3">{text.parcheIoText}</div>
            </div>
        </div>
    );
});
