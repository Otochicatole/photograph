        ...
        <div className="flex flex-col w-full items-center justify-center" >
            ...
            <div className="flex flex-row items-center max-w-[800px] justify-center gap-3 ">
                <div className="flex flex-col min-w-[300px] min-h-[440px] relative">
                    <img className="absolute -top-29 -left-26 rotate-y-180 z-0" src="./RECURSOS/hoja1.png" alt="" />
                    <img className="w-[300px] h-[440px] min-w-[300px] min-h-[440px] z-10 object-cover rounded-[10px]  drop-shadow-lg" src="./FOTOGRAFIAS/FOTOGRAFO/1.jpg" alt="" width={300} height={440} />
                </div>
            ...
            <div className="flex flex-col items-center justify-center w-[400px] mt-26 relative ">
                <img className="absolute rotate-99 z-0 opacity-50 right-20" src="./RECURSOS/hoja2.png" alt="" width={124} height={230} />
            ...
            <div className="flex flex-row items-center max-w-[1000px] justify-center gap-55 ">
                <div className="flex flex-col min-w-[300px] min-h-[440px] relative">
                    <img className="absolute -top-23 -left-38  z-0" src="./RECURSOS/hoja3.png" alt="" />
                    <img className="absolute -bottom-16 -right-3 rotate-135 w-[147px] h-[261px]  z-0" src="./RECURSOS/hoja1.png" alt="" />
                    <img className="w-[300px] h-[440px] min-w-[300px] min-h-[440px] z-10 object-cover rounded-[10px]  drop-shadow-lg" src="./FOTOGRAFIAS/FOTOGRAFO/1.jpg" alt="" width={300} height={440} />
                </div>
                <div className="flex flex-col h-full w-full p-3 ">
                    {text.parcheIoText}
